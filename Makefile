...
CMPL_SRCS	=  main.cpp Game.cpp HoldEmGame.cpp PinochleGame.cpp Suit.cpp PinochleDeck.cpp HoldEmDeck.cpp UnoDeck.cpp

#               Source files containing only template class method definitions
TMPL_SRCS	= Card_T.cpp Deck_T.cpp CardSet_T.cpp GoFishGame_T.cpp

#               Header (.h) files
HEADER_FILES    = Game.h HoldEmGame.h PinochleGame.h Suit.h Card_T.h Deck_T.h CardSet_T.h GoFishGame_T.h PinochleDeck.h Deck.h HoldEmDeck.h UnoDeck.h
